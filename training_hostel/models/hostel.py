...
class HostelType(models.Model):
    ...
    def _search(self, args, offset=0, limit=None, order=None, count=False,
        ...
        if self._context.get('student_id'):
            stud_obj = self.env['learning.student']
...
class HostelRoom(models.Model):
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False,
        ...
        res = super(HostelRoom, self).fields_view_get(view_id=view_id,
                                                      ...
                                                      toolbar=toolbar,
                                                      submenu=submenu)
        user_group = self.env.user.has_group('training_hostel.group_hostel_user')
...
class HostelStudent(models.Model):
    ...
    student_id = fields.Many2one('learning.student', 'Student')
